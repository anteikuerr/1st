...
const SUGGEST_WEIGHTS = {
  ...
  trainerSlots: 10, // トレーナー枠。複数の構築ガイド(アルテマ/Game8/GameWith)は
                    // 「ポケモン8〜10枚・トレーナー10〜12枚・たね多め・進化少なめ」で一致。
                    // 枠を10にするとポケモンが薄まり、弱い進化ライン(ポポッコ等の中継ぎ)が
                    // 入り込む余地が消える。実験でも勝率50.6→51.5%と改善(ポポッコ混入0に)
